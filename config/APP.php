<?php
	...
	----------*/
	const SERVERURL="http://localhost/AppWebV1.0/";


	/*----------  
	Nombre de la empresa o compañia -  Company or company name
	----------*/
	const COMPANY="Rancho de Fercho";
	...
	const PRODUTS_UNITS=["Unidad","Libra","Kilogramo","Lata","Botella","Otro"];
