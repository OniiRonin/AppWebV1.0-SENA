	...
	class loginControlador extends mainModel{
		...
		public function iniciar_sesion_administrador_controlador(){
			...
			if($datos_cuenta->rowCount()==1){
				...
				$_SESSION['id_database']=$row['usuario_id'];
				$_SESSION['nombre_database']=$row['usuario_nombre'];
				$_SESSION['apellido_database']=$row['usuario_apellido'];
				$_SESSION['genero_database']=$row['usuario_genero'];
				$_SESSION['usuario_database']=$row['usuario_usuario'];
				$_SESSION['cargo_database']=$row['usuario_cargo'];
				$_SESSION['foto_database']=$row['usuario_foto'];
				$_SESSION['token_database']=mainModel::encryption(uniqid(mt_rand(), true));
		...
		public function cerrar_sesion_administrador_controlador(){
			...
			if($token==$_SESSION['token_database'] && $usuario==$_SESSION['usuario_database']){
				unset($_SESSION['id_database']);
				unset($_SESSION['nombre_database']);
				unset($_SESSION['apellido_database']);
				unset($_SESSION['genero_database']);
				unset($_SESSION['usuario_database']);
				unset($_SESSION['cargo_database']);
				unset($_SESSION['foto_database']);
				unset($_SESSION['token_database']);
				$alerta=[
