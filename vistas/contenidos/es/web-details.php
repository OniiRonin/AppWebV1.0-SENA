                ...
                <div class="col-12 col-lg-7">
                    ...
                    <div class="container-fluid" style="padding-top: 50px;">
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6 mb-4"">
                                <strong class="text-uppercase"><i class="fas fa-box fa-fw"></i> Stock:</strong> &nbsp: <?php if($campos['producto_tipo']=="Mesa"){ echo $campos['producto_stock']; }else{ echo "Disponible"; } ?>
                            </div>
                            <div class="col-12 col-md-6 mb-4"">
