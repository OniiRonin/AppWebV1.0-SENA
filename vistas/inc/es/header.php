    ...
    <div class="header-options full-box">
        <nav class="header-navbar full-box poppins-regular font-weight-bold scroll" onclick="show_menu_mobile()" >
            <ul class="list-unstyled full-box" >
                ...
                <?php if(!isset($_SESSION['cargo_database'])){ ?>
                <li>
        ...
        <?php if(isset($_SESSION['cargo_database']) && ($_SESSION['cargo_database']=="Administrador" || $_SESSION['cargo_database']=="Cajero")){ ?>
            <div class="header-button full-box text-center" id="userMenu" data-mdb-toggle="dropdown" aria-haspopup="true" aria-expanded="false" title="<?php echo $_SESSION['usuario_database']; ?>" >
                <i class="fas fa-user-circle"></i>
            </div>
            <div class="dropdown-menu div-bordered popup-login" aria-labelledby="userMenu">
                <p class="text-center" style="padding-top: 10px;">
                    <i class="fas fa-user-circle fa-3x"></i><br>
                    <small><?php echo $_SESSION['usuario_database']; ?></small>
                </p>
