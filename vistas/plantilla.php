...
<body id="main-body" class="scroll">
    <?php
        ...
        if(isset($pagina[0]) && DASHBOARD==$pagina[0]){
            ...
            if($vistas=="login" || $vistas=="404"){
                ...
                if(!isset($_SESSION['token_database']) || !isset($_SESSION['id_database']) || !isset($_SESSION['nombre_database']) || !isset($_SESSION['apellido_database']) || !isset($_SESSION['usuario_database']) || !isset($_SESSION['cargo_database'])){
    ...
    <?php
            ...
            if($vistas=="404"){
                ...
                if(isset($_SESSION['cargo_database']) && ($_SESSION['cargo_database']=="Administrador" || $_SESSION['cargo_database']=="Cajero")){
                    include "./vistas/inc/log_out_admin.php";
                }
            }
        }
